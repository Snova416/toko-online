...
<div class="alert alert-primary shadow mt-3">
    <a href="download_laporan.php?tglm=<?php echo $tgl_mulai; ?>
    &tgls=<?php echo $tgl_selesai; ?>&status=<?php echo $status; ?>" class="btn btn-success" target="_blank">Download Laporan</a>
</div>
<?php endif; ?>
