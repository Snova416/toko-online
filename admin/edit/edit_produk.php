...
$ambil = $koneksi->query("SELECT * FROM produk_foto JOIN produk ON produk_foto.id_produk=produk.id_produk WHERE id_produk_foto='$id_produk'");
    ...
    <div class="card shadow bg-white">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea name="deskripsi" class="form-control"><?php echo $edit['deskripsi_produk']; ?></textarea>
                </div>
            </div>
