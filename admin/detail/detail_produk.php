...
<div class="card shadow bg-white">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input readonly class="form-control" placeholder="<?php echo $detailproduk['nama_kategori'];?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Nama Produk :</label>
            <div class="col-sm-9">
                <input readonly class="form-control" placeholder="<?php echo $detailproduk['nama_produk'];?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Harga Produk :</label>
            <div class="col-sm-9">
                <input readonly class="form-control" placeholder="<?php echo $detailproduk['harga_produk'];?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <textarea disabled class="form-control"><?php echo $detailproduk['deskripsi_produk'];?></textarea>
            </div>
        </div>
        <div class="form-group row">
