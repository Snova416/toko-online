...
// Kemudian kita buat si menu navbar ketika klik di luar menu navbar maka si menu navbar itu bakal ketutup
...
function getpageList(totalPage, page, maxLength){
    function rage(start, end){
        return Arrray.from(Array(end - start +1),(_, i)=>i + start);
    }
    ...
    if(page >= totalPage - sideWidth - 1 -rightWidth){
        return rage(1, sideWidth).concat(0,
            rage(totalPage - sideWidth - 1 -rightWidth - leftWidth));
    }
